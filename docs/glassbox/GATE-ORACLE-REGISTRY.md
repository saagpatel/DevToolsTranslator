...
| 1 | Encryption/App Sandbox feasibility | `scripts/glassbox/verify_storage_sandbox_spike.sh` | `glassbox-storage-spike/v1` with candidate/license/WAL/crash/perf result | Planned; blocks persistent schema |
