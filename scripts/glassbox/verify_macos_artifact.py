...
local_checks={
 ...
 "privacy_manifest_present_and_no_collection":privacy.get("NSPrivacyTracking") is False and privacy.get("NSPrivacyCollectedDataTypes")==[] and privacy.get("NSPrivacyAccessedAPITypes")==[],
